...
const OrderListProvider = ({children}) => {
  ...
  const [clothingSizes] = useState([
    {id: 1, value: 'T-PP', gender: 'MALE', color: '#a5c6ff'},
    {id: 2, value: 'T-P', gender: 'MALE', color: '#a5c6ff'},
    {id: 3, value: 'T-M', gender: 'MALE', color: '#a5c6ff'},
    {id: 4, value: 'T-G', gender: 'MALE', color: '#a5c6ff'},
    {id: 5, value: 'T-GG', gender: 'MALE', color: '#a5c6ff'},
    {id: 6, value: 'T-XG', gender: 'MALE', color: '#a5c6ff'},
    {id: 7, value: 'T-2XG', gender: 'MALE', color: '#a5c6ff'},
    {id: 8, value: 'T-3XG', gender: 'MALE', color: '#a5c6ff'},
    {id: 9, value: 'T-4XG', gender: 'MALE', color: '#a5c6ff'},

    {id: 10, value: 'T-PP', gender: 'FEMALE', color: '#fcb8ff'},
    {id: 11, value: 'T-P', gender: 'FEMALE', color: '#fcb8ff'},
    {id: 12, value: 'T-M', gender: 'FEMALE', color: '#fcb8ff'},
    {id: 13, value: 'T-G', gender: 'FEMALE', color: '#fcb8ff'},
    {
      id: 14,
      value: 'T-GG',
      gender: 'FEMALE',
